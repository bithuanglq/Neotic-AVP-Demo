...
std::string mapSaveLocation="~/catkin_ws/src/avp_slam/my_data/icpLaserCloud.pcd";
...
int main(int argc, char *argv[]){
    ...
    nh.param<std::string>("mapSaveLocation", mapSaveLocation, "~/catkin_ws/src/avp_slam/my_data/icpLaserCloud.pcd");
    ...
    if(mapSave){
       std::cout << "map save start" << std::endl;
       pcl::PointCloud<PointType>  globalMap=*globalFeatureCloud;
       std::cout << "mapSaveLocation:" << mapSaveLocation << std::endl;    // absolute path  
       pcl::io::savePCDFileASCII(mapSaveLocation, *globalFeatureCloud);        
	   std::cout << "map save over" << std::endl;
    }
